...
function employees_designation_table_delete($selected_id, $AllowDeleteOfParents = false, $skipChecks = false) {
	...
	$id = db_fetch_row($res);
	$rires = sql("SELECT COUNT(1) FROM `employees_appraisal_table` WHERE `employee_designation_reporting_lookup`='" . makeSafe($id[0]) . "'", $eo);
	$rirow = db_fetch_row($rires);
	$childrenATag = '<a class="alert-link" href="employees_appraisal_table_view.php?filterer_employee_designation_reporting_lookup=' . urlencode($id[0]) . '">%s</a>';
