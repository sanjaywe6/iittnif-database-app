...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = [
		...
		"`event_decision_table`.`username`" => "username",
	...
	$x->SortFields = [
		...
		2 => 2,
		3 => '`outcomes_expected_table1`.`outcomes_expected_str`',
		4 => 4,
		5 => 5,
		6 => '`event_decision_table`.`action_taken_with_date`',
		7 => 7,
		8 => '`event_decision_table`.`decision_status_update_date`',
		9 => 9,
		10 => 10,
		11 => 11,
		12 => 12,
	...
	$x->ColCaption = ['ID', 'Username', 'Expected Outcomes of Meeting', 'Decision description', 'Decision actor', 'Action taken with date', 'Decision status', 'Decision status update date', 'Decision status remarks by superior', 'Last updated by', 'Last updated at', 'Created By', ];
	$x->ColFieldName = ['decision_id', 'username', 'outcomes_expected_lookup', 'decision_description', 'decision_actor', 'action_taken_with_date', 'decision_status', 'decision_status_update_date', 'decision_status_remarks_by_superior', 'last_updated_by', 'last_updated_at', 'created_by', ];
