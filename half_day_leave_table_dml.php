			...
			$j("#approved_by-container__RAND__").select2({
				...
				initSelection: function(e, c) {
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_approved_by__RAND__.value, t: 'half_day_leave_table', f: 'approved_by' },
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page) { return { s: term, p: page, t: 'half_day_leave_table', f: 'approved_by' }; },
