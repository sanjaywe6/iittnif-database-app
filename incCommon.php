		...
		$pcConfig = [
			...
			'r_and_d_monthly_progress_app' => [
				'r_and_d_lookup' => [
					...
					'child-primary-key' => 'id',
					'child-primary-key-index' => 0,
					'tab-label' => 'R and d monthly progress app <span class="hidden child-label-r_and_d_monthly_progress_app child-field-caption">(R and D Progress Details)</span>',
					'auto-close' => false,
					'table-icon' => 'table.gif',
					'display-refresh' => true,
					'display-add-new' => true,
			...
			'r_and_d_quarterly_progress_app' => [
				'r_and_d_lookup' => [
					...
					'child-primary-key' => 'id',
					'child-primary-key-index' => 0,
					'tab-label' => 'Monthly Progress App <span class="hidden child-label-r_and_d_quarterly_progress_app child-field-caption">(R and D Progress Details)</span>',
					'auto-close' => false,
					'table-icon' => 'table.gif',
					'display-refresh' => true,
					'display-add-new' => true,
