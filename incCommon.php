		...
		$pcConfig = [
			...
			'employees_designation_table' => [
				'employee_details' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 1 => 'Employee details', 2 => 'Designation', 3 => 'Date of appointment to designation', 4 => 'Active status', 5 => 'Created by', 6 => 'Created at', 7 => 'Last updated by', 8 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 1 => 'employee_details', 2 => 'designation', 3 => 'date_of_appointment_to_designation', 4 => 'active_status', 5 => 'created_by', 6 => 'created_at', 7 => 'last_updated_by', 8 => 'last_updated_at'],
					'sortable-fields' => [0 => '`employees_designation_table`.`id`', 1 => 2, 2 => 3, 3 => '`employees_designation_table`.`date_of_appointment_to_designation`', 4 => 5, 5 => 6, 6 => 7, 7 => 8, 8 => 9],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
