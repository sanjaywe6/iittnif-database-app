	...
	*/
	...
	function get_sql_from($table_name, $skip_permissions = false, $skip_joins = false, $lower_permissions = false) {
		$sql_from = [
			...
			'beyond_workingHours_table' => "`beyond_workingHours_table` LEFT JOIN `user_table` as user_table1 ON `user_table1`.`user_id`=`beyond_workingHours_table`.`approved_by` ",
			'leave_table' => "`leave_table` LEFT JOIN `user_table` as user_table1 ON `user_table1`.`user_id`=`leave_table`.`approved_by` ",
			'half_day_leave_table' => "`half_day_leave_table` LEFT JOIN `user_table` as user_table1 ON `user_table1`.`user_id`=`half_day_leave_table`.`approved_by` ",
		...
		$pcConfig = [
			...
			'approval_table' => [
				'person_responsbility' => [
					...
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Approval From', 3 => 'Approval Type', 4 => 'Description', 5 => 'Quantity', 6 => 'Full Estimated Value', 7 => 'Name of Vendor', 8 => 'Purpose', 9 => 'Requested Department/Appointment', 10 => 'Person Responsbility', 11 => 'Mode of Purchase', 13 => 'Approval Status', 14 => 'Remarks for Approval', 15 => 'Upload Image if Any (Optional)', 16 => 'Upload Other File if Any (Optional)', 17 => 'Created By', 18 => 'Last Updated By'],
					'display-field-names' => [0 => 'id', 2 => 'approval_from', 3 => 'type', 4 => 'description', 5 => 'quantity', 6 => 'full_est_value', 7 => 'name_of_vendor', 8 => 'purpose', 9 => 'requested_department', 10 => 'person_responsbility', 11 => 'mode_of_purchase', 13 => 'approval_status', 14 => 'remarks_for_approval', 15 => 'image', 16 => 'other_file', 17 => 'created_by', 18 => 'last_updated_by'],
			...
			'car_usage_table' => [
				'car_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Select Car', 3 => 'Used by', 4 => 'Date and time from', 5 => 'Date and time to', 6 => 'Total distance run (In KM)', 7 => 'Purpose', 8 => 'Created By', 9 => 'Last Updated By'],
					'display-field-names' => [0 => 'car_usage_id', 2 => 'car_lookup', 3 => 'used_by', 4 => 'datetime_from', 5 => 'datetime_to', 6 => 'total_distance_run', 7 => 'purpose', 8 => 'created_by', 9 => 'last_updated_by'],
			...
			'cycle_table' => [
				'responsible_contact_person' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Registration number', 3 => 'Cycle model', 4 => 'Cycle color', 5 => 'Responsible Contact Person', 6 => 'Contact number of person', 7 => 'Purpose', 8 => 'Created By', 9 => 'Last Updated By'],
					'display-field-names' => [0 => 'id', 2 => 'registration_number', 3 => 'cycle_model', 4 => 'cycle_color', 5 => 'responsible_contact_person', 6 => 'contact_number_of_person', 7 => 'purpose', 8 => 'created_by', 9 => 'last_updated_by'],
			...
			'cycle_usage_table' => [
				'cycle_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Cycle Details', 3 => 'Used by', 4 => 'Date and time from', 5 => 'Date and time to', 6 => 'Total distance run (In KM)', 7 => 'Remarks (Optional)', 8 => 'Created By', 9 => 'Last Updated By'],
					'display-field-names' => [0 => 'id', 2 => 'cycle_lookup', 3 => 'used_by', 4 => 'datetime_from', 5 => 'datetime_to', 6 => 'total_distance_run', 7 => 'remarks', 8 => 'created_by', 9 => 'last_updated_by'],
			...
			'outcomes_expected_table' => [
				'event_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Event', 3 => 'Target audience', 4 => 'Expected outcomes', 6 => 'Created By', 7 => 'Last Updated By'],
					'display-field-names' => [0 => 'outcomes_expected_id', 2 => 'event_lookup', 3 => 'target_audience', 4 => 'expected_outcomes', 6 => 'created_by', 7 => 'last_updated_by'],
			...
			'event_decision_table' => [
				'outcomes_expected_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Expected Outcomes of Meeting', 3 => 'Decision description', 4 => 'Decision actor', 5 => 'Action taken with date', 6 => 'Decision status', 7 => 'Decision status update date', 8 => 'Decision status remarks by superior', 10 => 'Created By', 11 => 'Last Updated By'],
					'display-field-names' => [0 => 'decision_id', 2 => 'outcomes_expected_lookup', 3 => 'decision_description', 4 => 'decision_actor', 5 => 'action_taken_with_date', 6 => 'decision_status', 7 => 'decision_status_update_date', 8 => 'decision_status_remarks_by_superior', 10 => 'created_by', 11 => 'last_updated_by'],
			...
			'meetings_table' => [
				'visiting_card_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 4 => 'Meeting title', 5 => 'Participants', 6 => 'Venue', 7 => 'Meeting from date', 8 => 'Meeting to date', 9 => 'Minutes of Meeting', 11 => 'Created By', 12 => 'Last Updated By'],
					'display-field-names' => [0 => 'meetings_id', 4 => 'meeting_title', 5 => 'participants', 6 => 'venue', 7 => 'meeting_from_date', 8 => 'meeting_to_date', 9 => 'minutes_of_meeting', 11 => 'created_by', 12 => 'last_updated_by'],
			...
			'agenda_table' => [
				'meeting_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Meeting', 3 => 'Agenda description', 5 => 'Created By', 6 => 'Last Updated By'],
					'display-field-names' => [0 => 'agenda_id', 2 => 'meeting_lookup', 3 => 'agenda_description', 5 => 'created_by', 6 => 'last_updated_by'],
			...
			'decision_table' => [
				'agenda_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Agenda of Meeting', 3 => 'Decision description', 4 => 'Decision actor', 5 => 'Action taken with date', 6 => 'Decision status', 7 => 'Decision status update date', 8 => 'Decision status remarks by superior', 10 => 'Created By', 11 => 'Last Updated By'],
					'display-field-names' => [0 => 'decision_id', 2 => 'agenda_lookup', 3 => 'decision_description', 4 => 'decision_actor', 5 => 'action_taken_with_date', 6 => 'decision_status', 7 => 'decision_status_update_date', 8 => 'decision_status_remarks_by_superior', 10 => 'created_by', 11 => 'last_updated_by'],
			...
			'participants_table' => [
				'event_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Event', 3 => 'Meeting', 4 => 'Name', 5 => 'Designation', 6 => 'Participant type', 7 => 'Accepted status', 8 => 'Status date', 9 => 'Created By', 10 => 'Last Updated By'],
					'display-field-names' => [0 => 'participants_id', 2 => 'event_lookup', 3 => 'meeting_lookup', 4 => 'name', 5 => 'designation', 6 => 'participant_type', 7 => 'accepted_status', 8 => 'status_date', 9 => 'created_by', 10 => 'last_updated_by'],
			...
			'action_actor' => [
				'actor' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 3 => 'Actor', 4 => 'Action status', 5 => 'Created By', 6 => 'Last Updated By'],
					'display-field-names' => [0 => 'actor_ID', 3 => 'actor', 4 => 'action_status', 5 => 'created_by', 6 => 'last_updated_by'],
			...
			'visiting_card_table' => [
				'given_by' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Name', 3 => 'Recommended by', 4 => 'Designation', 5 => 'Company name', 6 => 'Mobile no', 7 => 'Email', 8 => 'Company website address', 9 => 'Given by', 10 => 'Suggested way forward', 11 => 'Front img', 12 => 'Back img', 14 => 'Last updated by', 15 => 'Last updated at', 16 => 'Created By'],
					'display-field-names' => [0 => 'visiting_card_id', 2 => 'name', 3 => 'recommended_by', 4 => 'designation', 5 => 'company_name', 6 => 'mobile_no', 7 => 'email', 8 => 'company_website_addr', 9 => 'given_by', 10 => 'suggested_way_forward', 11 => 'front_img', 12 => 'back_img', 14 => 'last_updated_by', 15 => 'last_updated_at', 16 => 'created_by'],
			...
			'mou_details_table' => [
				'assigned_mou_to' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Type', 3 => 'Company name', 4 => 'Objectives/ Scope of the MOU', 5 => 'Agreement period (In Years)', 6 => 'Date of agreement', 7 => 'Date of expiry', 8 => 'Status', 9 => 'Point of contact (Name)', 10 => 'Contact number', 11 => 'Contact email id', 12 => 'Website link', 13 => 'Country', 14 => 'Assigned MoU to', 15 => 'Upload MoU (PDF or DOC format)', 16 => 'Last updated by', 17 => 'Last updated at', 18 => 'Created By'],
					'display-field-names' => [0 => 'id', 2 => 'type', 3 => 'company_name', 4 => 'objective_of_mou', 5 => 'agreement_period', 6 => 'date_of_agreement', 7 => 'date_of_expiry', 8 => 'status', 9 => 'point_of_contact', 10 => 'contact_number', 11 => 'contact_email_id', 12 => 'website_link', 13 => 'country', 14 => 'assigned_mou_to', 15 => 'upload_mou', 16 => 'last_updated_by', 17 => 'last_updated_at', 18 => 'created_by'],
			...
			'mou_company_area_details_table' => [
				'name_of_the_company' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Name of the company', 3 => 'Area / Scope', 4 => 'Assigned MoU to', 5 => 'Remarks', 6 => 'Last updated by', 7 => 'Last updated at', 8 => 'Created By'],
					'display-field-names' => [0 => 'id', 2 => 'name_of_the_company', 3 => 'area', 4 => 'assigned_mou_to', 5 => 'remarks', 6 => 'last_updated_by', 7 => 'last_updated_at', 8 => 'created_by'],
			...
			'goal_setting_table' => [
				'supervisor_name' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Goal status', 3 => 'Goal description', 4 => 'Goal duration', 5 => 'Goal set date', 6 => 'Supervisor name', 7 => 'Assigned to', 8 => 'Goal setting str', 9 => 'Last updated by', 10 => 'Last updated at', 11 => 'Created By'],
					'display-field-names' => [0 => 'goal_id', 2 => 'goal_status', 3 => 'goal_description', 4 => 'goal_duration', 5 => 'goal_set_date', 6 => 'supervisor_name', 7 => 'assigned_to', 8 => 'goal_setting_str', 9 => 'last_updated_by', 10 => 'last_updated_at', 11 => 'created_by'],
			...
			'goal_progress_table' => [
				'goal_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Goal details', 3 => 'Goal progress', 4 => 'Remarks by', 5 => 'Remarks', 6 => 'Last updated by', 7 => 'Created By', 8 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 2 => 'goal_lookup', 3 => 'goal_progress', 4 => 'remarks_by', 5 => 'remarks', 6 => 'last_updated_by', 7 => 'created_by', 8 => 'last_updated_at'],
			...
			'task_setting_table' => [
				'supervisor_name' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Task status', 3 => 'Task description', 4 => 'Task duration', 5 => 'Task set date', 6 => 'Supervisor name', 7 => 'Assigned to', 9 => 'Last updated by', 10 => 'Last updated at', 11 => 'Created By'],
					'display-field-names' => [0 => 'task_id', 2 => 'task_status', 3 => 'task_description', 4 => 'task_duration', 5 => 'task_set_date', 6 => 'supervisor_name', 7 => 'assigned_to', 9 => 'last_updated_by', 10 => 'last_updated_at', 11 => 'created_by'],
			...
			'subtask_setting_table' => [
				'task_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Task', 3 => 'Subtask status', 4 => 'Subtask description', 5 => 'Subtask duration', 6 => 'Subtask set date', 7 => 'Supervisor name', 8 => 'Assigned to', 9 => 'Subtask setting str', 10 => 'Last updated by', 11 => 'Last updated at', 12 => 'Created By'],
					'display-field-names' => [0 => 'subtask_id', 2 => 'task_lookup', 3 => 'subtask_status', 4 => 'subtask_description', 5 => 'subtask_duration', 6 => 'subtask_set_date', 7 => 'supervisor_name', 8 => 'assigned_to', 9 => 'subtask_setting_str', 10 => 'last_updated_by', 11 => 'last_updated_at', 12 => 'created_by'],
			...
			'star_pnt' => [
				'iittnif_id' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'IITTNiF id', 3 => 'Name of the Candidate', 4 => 'Institute', 5 => 'Workspace', 6 => 'Year and department', 7 => 'Project title', 8 => 'Created by', 9 => 'Created at', 10 => 'Last updated by', 11 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 2 => 'iittnif_id', 3 => 'name_of_the_candidate', 4 => 'institute', 5 => 'workspace', 6 => 'year_and_department', 7 => 'project_title', 8 => 'created_by', 9 => 'created_at', 10 => 'last_updated_by', 11 => 'last_updated_at'],
			...
			'asset_allotment_table' => [
				'asset_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Asset Details', 3 => 'Select employee', 4 => 'Department', 5 => 'Date', 6 => 'Purpose', 7 => 'Alloted by', 8 => 'Status', 9 => 'Returned date', 10 => 'Created by', 11 => 'Created at', 12 => 'Last updated by', 13 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 2 => 'asset_lookup', 3 => 'select_employee', 4 => 'department', 5 => 'date', 6 => 'purpose', 7 => 'alloted_by', 8 => 'status', 9 => 'returned_date', 10 => 'created_by', 11 => 'created_at', 12 => 'last_updated_by', 13 => 'last_updated_at'],
			...
			'sub_asset_allotment_table' => [
				'sub_asset_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Sub Asset Details', 3 => 'Select employee', 4 => 'Department', 5 => 'Date', 6 => 'Purpose', 7 => 'Alloted by', 8 => 'Status', 9 => 'Returned date', 10 => 'Created by', 11 => 'Created at', 12 => 'Last updated by', 13 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 2 => 'sub_asset_lookup', 3 => 'select_employee', 4 => 'department', 5 => 'date', 6 => 'purpose', 7 => 'alloted_by', 8 => 'status', 9 => 'returned_date', 10 => 'created_by', 11 => 'created_at', 12 => 'last_updated_by', 13 => 'last_updated_at'],
			...
			'it_inventory_billing_details' => [
				'it_inventory_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'IT inventory ', 3 => 'PO Number', 4 => 'PO Date', 5 => 'Particulars of supplier', 6 => 'Item description', 7 => 'Bill no', 8 => 'Bill date', 9 => 'Quantity', 10 => 'Total invoice value', 11 => 'Cost of the asset', 12 => 'Image', 13 => 'Created by', 14 => 'Created at', 15 => 'Last updated by', 16 => 'Last updated at'],
					'display-field-names' => [0 => 'it_inventory_biling_details_id', 2 => 'it_inventory_lookup', 3 => 'po_no', 4 => 'po_date', 5 => 'particulars_of_supplier', 6 => 'item_description', 7 => 'bill_no', 8 => 'bill_date', 9 => 'quantity', 10 => 'total_invoice_value', 11 => 'cost_of_the_asset', 12 => 'image', 13 => 'created_by', 14 => 'created_at', 15 => 'last_updated_by', 16 => 'last_updated_at'],
			...
			'it_inventory_allotment_table' => [
				'select_employee' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Select employee', 3 => 'Department', 4 => 'Date', 5 => 'Inventory Details', 6 => 'Purpose', 7 => 'Alloted by', 8 => 'Allotment Status', 9 => 'Approval status', 10 => 'Approved By', 11 => 'Approval remarks', 12 => 'Return status', 13 => 'Returned date', 14 => 'Created by', 15 => 'Created at', 16 => 'Last updated by', 17 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 2 => 'select_employee', 3 => 'department', 4 => 'date', 5 => 'inventory_details', 6 => 'purpose', 7 => 'alloted_by', 8 => 'allotment_status', 9 => 'approval_status', 10 => 'approved_by', 11 => 'approval_remarks', 12 => 'return_status', 13 => 'returned_date', 14 => 'created_by', 15 => 'created_at', 16 => 'last_updated_by', 17 => 'last_updated_at'],
					'sortable-fields' => [0 => '`it_inventory_allotment_table`.`id`', 1 => 2, 2 => 3, 3 => 4, 4 => '`it_inventory_allotment_table`.`date`', 5 => 6, 6 => 7, 7 => 8, 8 => 9, 9 => 10, 10 => 11, 11 => 12, 12 => 13, 13 => '`it_inventory_allotment_table`.`returned_date`', 14 => 15, 15 => 16, 16 => 17, 17 => 18],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
				...
				'approved_by' => [
					...
					'child-primary-key' => 'id',
					'child-primary-key-index' => 0,
					'tab-label' => 'Asset allotment - App <span class="hidden child-label-it_inventory_allotment_table child-field-caption">(Approved By)</span>',
					'auto-close' => false,
					'table-icon' => 'table.gif',
					'display-refresh' => true,
					'display-add-new' => true,
			...
			'computer_user_details' => [
				'pc_id' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 1 => 'Pc ID', 3 => 'Entry time', 4 => 'Exit time', 5 => 'Date', 6 => 'Created By', 7 => 'Last Updated By'],
					'display-field-names' => [0 => 'id', 1 => 'pc_id', 3 => 'entry_time', 4 => 'exit_time', 5 => 'date', 6 => 'created_by', 7 => 'last_updated_by'],
			...
			'computer_allotment_table' => [
				'pc_id' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 1 => 'Pc ID', 3 => 'Name of user', 4 => 'Role', 5 => 'From date', 6 => 'To date', 7 => 'Purpose', 8 => 'Email ID', 9 => 'Mobile number', 10 => 'Created by', 11 => 'Created at', 12 => 'Last updated by', 13 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 1 => 'pc_id', 3 => 'name_of_user', 4 => 'role', 5 => 'from_date', 6 => 'to_date', 7 => 'purpose', 8 => 'email_d', 9 => 'mobile_number', 10 => 'created_by', 11 => 'created_at', 12 => 'last_updated_by', 13 => 'last_updated_at'],
			...
			'employees_designation_table' => [
				'employee_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Employee Details', 3 => 'Designation', 4 => 'Date of appointment to designation', 5 => 'Active status', 6 => 'Reporting Officer', 7 => 'Reviewing Officer', 8 => 'Created by', 9 => 'Created at', 10 => 'Last updated by', 11 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 2 => 'employee_lookup', 3 => 'designation', 4 => 'date_of_appointment_to_designation', 5 => 'active_status', 6 => 'reporting_officer', 7 => 'reviewing_officer', 8 => 'created_by', 9 => 'created_at', 10 => 'last_updated_by', 11 => 'last_updated_at'],
			...
			'beyond_workingHours_table' => [
				'approved_by' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Reson for overtime', 3 => 'Start Date & Time', 4 => 'End Date & Time', 5 => 'Number of hours', 6 => 'Approval status', 7 => 'Approval remarks', 8 => 'Approved by', 9 => 'Created by', 10 => 'Created at', 11 => 'Last updated by', 12 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 2 => 'reson_for_overtime', 3 => 'start_datetime', 4 => 'end_datetime', 5 => 'number_of_hours', 6 => 'approval_status', 7 => 'approval_remarks', 8 => 'approved_by', 9 => 'created_by', 10 => 'created_at', 11 => 'last_updated_by', 12 => 'last_updated_at'],
					...
					'query' => "SELECT `beyond_workingHours_table`.`id` as 'id', `beyond_workingHours_table`.`username` as 'username', `beyond_workingHours_table`.`reson_for_overtime` as 'reson_for_overtime', if(`beyond_workingHours_table`.`start_datetime`,date_format(`beyond_workingHours_table`.`start_datetime`,'%d/%m/%Y %H:%i'),'') as 'start_datetime', if(`beyond_workingHours_table`.`end_datetime`,date_format(`beyond_workingHours_table`.`end_datetime`,'%d/%m/%Y %H:%i'),'') as 'end_datetime', `beyond_workingHours_table`.`number_of_hours` as 'number_of_hours', `beyond_workingHours_table`.`approval_status` as 'approval_status', `beyond_workingHours_table`.`approval_remarks` as 'approval_remarks', IF(    CHAR_LENGTH(`user_table1`.`memberID`) || CHAR_LENGTH(`user_table1`.`name`), CONCAT_WS('',   `user_table1`.`memberID`, '::', `user_table1`.`name`), '') as 'approved_by', `beyond_workingHours_table`.`created_by` as 'created_by', `beyond_workingHours_table`.`created_at` as 'created_at', `beyond_workingHours_table`.`last_updated_by` as 'last_updated_by', `beyond_workingHours_table`.`last_updated_at` as 'last_updated_at' FROM `beyond_workingHours_table` LEFT JOIN `user_table` as user_table1 ON `user_table1`.`user_id`=`beyond_workingHours_table`.`approved_by` "
				],
			],
			'leave_table' => [
				'approved_by' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Leave type', 3 => 'Purpose of leave', 4 => 'From Date', 5 => 'To Date & Time', 6 => 'Approval status', 7 => 'Approval remarks', 8 => 'Approved By', 9 => 'Created by', 10 => 'Created at', 11 => 'Last updated by', 12 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 2 => 'leave_type', 3 => 'purpose_of_leave', 4 => 'from_date', 5 => 'to_date', 6 => 'approval_status', 7 => 'approval_remarks', 8 => 'approved_by', 9 => 'created_by', 10 => 'created_at', 11 => 'last_updated_by', 12 => 'last_updated_at'],
					'sortable-fields' => [0 => '`leave_table`.`id`', 1 => 2, 2 => 3, 3 => 4, 4 => '`leave_table`.`from_date`', 5 => '`leave_table`.`to_date`', 6 => 7, 7 => 8, 8 => 9, 9 => 10, 10 => 11, 11 => 12, 12 => 13],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
					...
					'query' => "SELECT `leave_table`.`id` as 'id', `leave_table`.`username` as 'username', `leave_table`.`leave_type` as 'leave_type', `leave_table`.`purpose_of_leave` as 'purpose_of_leave', if(`leave_table`.`from_date`,date_format(`leave_table`.`from_date`,'%d/%m/%Y'),'') as 'from_date', if(`leave_table`.`to_date`,date_format(`leave_table`.`to_date`,'%d/%m/%Y'),'') as 'to_date', `leave_table`.`approval_status` as 'approval_status', `leave_table`.`approval_remarks` as 'approval_remarks', IF(    CHAR_LENGTH(`user_table1`.`memberID`) || CHAR_LENGTH(`user_table1`.`name`), CONCAT_WS('',   `user_table1`.`memberID`, '::', `user_table1`.`name`), '') as 'approved_by', `leave_table`.`created_by` as 'created_by', `leave_table`.`created_at` as 'created_at', `leave_table`.`last_updated_by` as 'last_updated_by', `leave_table`.`last_updated_at` as 'last_updated_at' FROM `leave_table` LEFT JOIN `user_table` as user_table1 ON `user_table1`.`user_id`=`leave_table`.`approved_by` "
				],
			],
			'half_day_leave_table' => [
				'approved_by' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Leave type', 3 => 'Purpose of leave', 4 => 'Date', 5 => 'Approval status', 6 => 'Approval remarks', 7 => 'Approved By', 8 => 'Created by', 9 => 'Created at', 10 => 'Last updated by', 11 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 2 => 'leave_type', 3 => 'purpose_of_leave', 4 => 'date', 5 => 'approval_status', 6 => 'approval_remarks', 7 => 'approved_by', 8 => 'created_by', 9 => 'created_at', 10 => 'last_updated_by', 11 => 'last_updated_at'],
					'sortable-fields' => [0 => '`half_day_leave_table`.`id`', 1 => 2, 2 => 3, 3 => 4, 4 => '`half_day_leave_table`.`date`', 5 => 6, 6 => 7, 7 => 8, 8 => 9, 9 => 10, 10 => 11, 11 => 12],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
					...
					'query' => "SELECT `half_day_leave_table`.`id` as 'id', `half_day_leave_table`.`username` as 'username', `half_day_leave_table`.`leave_type` as 'leave_type', `half_day_leave_table`.`purpose_of_leave` as 'purpose_of_leave', if(`half_day_leave_table`.`date`,date_format(`half_day_leave_table`.`date`,'%d/%m/%Y'),'') as 'date', `half_day_leave_table`.`approval_status` as 'approval_status', `half_day_leave_table`.`approval_remarks` as 'approval_remarks', IF(    CHAR_LENGTH(`user_table1`.`memberID`) || CHAR_LENGTH(`user_table1`.`name`), CONCAT_WS('',   `user_table1`.`memberID`, '::', `user_table1`.`name`), '') as 'approved_by', `half_day_leave_table`.`created_by` as 'created_by', `half_day_leave_table`.`created_at` as 'created_at', `half_day_leave_table`.`last_updated_by` as 'last_updated_by', `half_day_leave_table`.`last_updated_at` as 'last_updated_at' FROM `half_day_leave_table` LEFT JOIN `user_table` as user_table1 ON `user_table1`.`user_id`=`half_day_leave_table`.`approved_by` "
				],
			],
			'work_from_home_table' => [
				'approved_by' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Purpose work from home', 3 => 'From date', 4 => 'To date', 5 => 'Approved by', 6 => 'Created by', 7 => 'Created at', 8 => 'Last updated by', 9 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 2 => 'work_from_home_purpose', 3 => 'from_date', 4 => 'to_date', 5 => 'approved_by', 6 => 'created_by', 7 => 'created_at', 8 => 'last_updated_by', 9 => 'last_updated_at'],
					'sortable-fields' => [0 => '`work_from_home_table`.`id`', 1 => 2, 2 => 3, 3 => '`work_from_home_table`.`from_date`', 4 => '`work_from_home_table`.`to_date`', 5 => '`user_table1`.`user_id`', 6 => 7, 7 => 8, 8 => 9, 9 => 10],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
			...
			'navavishkar_stay_table' => [
				'approved_by' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Full Name', 3 => 'Employee ID', 4 => 'Department', 5 => 'Designation', 6 => 'Contact Email', 7 => 'Contact Number', 8 => 'Room number', 9 => 'Check in date', 10 => 'Checkout date', 11 => 'Reason for stay', 12 => 'Approval status', 13 => 'Approval remarks', 14 => 'Approved By', 15 => 'Created by', 16 => 'Created at', 17 => 'Last updated by', 18 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 2 => 'full_name', 3 => 'emp_id', 4 => 'department', 5 => 'designation', 6 => 'contact_email', 7 => 'contact_number', 8 => 'room_number', 9 => 'check_in_date', 10 => 'checkout_date', 11 => 'reason_for_stay', 12 => 'approval_status', 13 => 'approval_remarks', 14 => 'approved_by', 15 => 'created_by', 16 => 'created_at', 17 => 'last_updated_by', 18 => 'last_updated_at'],
			...
			'navavishkar_stay_payment_table' => [
				'navavishakr_stay_details' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Navavishakr stay details', 3 => 'Payment status', 4 => 'Amount (INR)', 5 => 'Additional Facilities Provided (Optional)', 6 => 'Upload Payment Image', 7 => 'Remarks', 8 => 'Created by', 9 => 'Created at', 10 => 'Last updated by', 11 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 2 => 'navavishakr_stay_details', 3 => 'payment_status', 4 => 'amount', 5 => 'additional_facilities_provided', 6 => 'payment_img', 7 => 'remarks', 8 => 'created_by', 9 => 'created_at', 10 => 'last_updated_by', 11 => 'last_updated_at'],
			...
			'email_id_allocation_table' => [
				'reporting_manager' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Name of person', 3 => 'Allocated email id', 4 => 'Alternative email id', 5 => 'Date of allocation', 6 => 'Status', 7 => 'Reporting manager', 8 => 'Remarks', 9 => 'Created by', 10 => 'Created at', 11 => 'Last updated by', 12 => 'Last updated at'],
					'display-field-names' => [0 => 'email_id_allocation_id', 2 => 'name_of_person', 3 => 'allocated_email_id', 4 => 'alternative_email_id', 5 => 'date_of_allocation', 6 => 'status', 7 => 'reporting_manager', 8 => 'remarks', 9 => 'created_by', 10 => 'created_at', 11 => 'last_updated_by', 12 => 'last_updated_at'],
