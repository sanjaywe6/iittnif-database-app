		...
		$pcConfig = [
			...
			'car_usage_table' => [
				'car_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 1 => 'Select Car', 2 => 'Used by', 3 => 'Date and time from', 4 => 'Date and time to', 5 => 'Total distance run (In KM)', 6 => 'Purpose', 7 => 'Created By', 8 => 'Last Updated By', 9 => 'Created By Username', 10 => 'Created At', 11 => 'Last Updated by Username', 12 => 'Last Updated At'],
					'display-field-names' => [0 => 'car_usage_id', 1 => 'car_lookup', 2 => 'used_by', 3 => 'datetime_from', 4 => 'datetime_to', 5 => 'total_distance_run', 6 => 'purpose', 7 => 'created_by', 8 => 'last_updated_by', 9 => 'created_by_username', 10 => 'created_at', 11 => 'last_updated_by_username', 12 => 'last_updated_at'],
					'sortable-fields' => [0 => '`car_usage_table`.`car_usage_id`', 1 => 2, 2 => 3, 3 => '`car_usage_table`.`datetime_from`', 4 => '`car_usage_table`.`datetime_to`', 5 => 6, 6 => 7, 7 => 8, 8 => 9, 9 => 10, 10 => 11, 11 => 12, 12 => 13],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
