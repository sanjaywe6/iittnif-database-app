	...
	*/
	...
	function get_sql_fields($table_name) {
		$sql_fields = [
			...
			'honorarium_claim_table' => "`honorarium_claim_table`.`id` as 'id', `honorarium_claim_table`.`name_of_advisor` as 'name_of_advisor', `honorarium_claim_table`.`email_advisor` as 'email_advisor', `honorarium_claim_table`.`department_of_tih` as 'department_of_tih', `honorarium_claim_table`.`bank_account_no` as 'bank_account_no', `honorarium_claim_table`.`ifsc_code` as 'ifsc_code', `honorarium_claim_table`.`bank_name` as 'bank_name', `honorarium_claim_table`.`pan` as 'pan', `honorarium_claim_table`.`place_of_work_1` as 'place_of_work_1', `honorarium_claim_table`.`place_of_work_2` as 'place_of_work_2', `honorarium_claim_table`.`place_of_work_3` as 'place_of_work_3', `honorarium_claim_table`.`place_of_work_4` as 'place_of_work_4', `honorarium_claim_table`.`place_of_work_5` as 'place_of_work_5', `honorarium_claim_table`.`total_no_of_days` as 'total_no_of_days', `honorarium_claim_table`.`total_no_of_hours` as 'total_no_of_hours', `honorarium_claim_table`.`case_reference_email_subject` as 'case_reference_email_subject', `honorarium_claim_table`.`activities` as 'activities', `honorarium_claim_table`.`created_by` as 'created_by', `honorarium_claim_table`.`created_at` as 'created_at', `honorarium_claim_table`.`last_updated_by` as 'last_updated_by', `honorarium_claim_table`.`last_updated_at` as 'last_updated_at'",
	...
	function get_sql_from($table_name, $skip_permissions = false, $skip_joins = false, $lower_permissions = false) {
		$sql_from = [
			...
			'honorarium_claim_table' => "`honorarium_claim_table` ",
