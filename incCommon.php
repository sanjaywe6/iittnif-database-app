	...
	*/
	...
	function get_sql_fields($table_name) {
		$sql_fields = [
			...
			'beyond_workingHours_table' => "`beyond_workingHours_table`.`id` as 'id', `beyond_workingHours_table`.`reson_for_overtime` as 'reson_for_overtime', if(`beyond_workingHours_table`.`start_datetime`,date_format(`beyond_workingHours_table`.`start_datetime`,'%d/%m/%Y %H:%i'),'') as 'start_datetime', if(`beyond_workingHours_table`.`end_datetime`,date_format(`beyond_workingHours_table`.`end_datetime`,'%d/%m/%Y %H:%i'),'') as 'end_datetime', `beyond_workingHours_table`.`details_of_work_done` as 'details_of_work_done', `beyond_workingHours_table`.`number_of_hours` as 'number_of_hours', `beyond_workingHours_table`.`approval_status` as 'approval_status', `beyond_workingHours_table`.`approval_remarks` as 'approval_remarks', `beyond_workingHours_table`.`created_by_username` as 'created_by_username', `beyond_workingHours_table`.`created_by` as 'created_by', `beyond_workingHours_table`.`created_at` as 'created_at', `beyond_workingHours_table`.`last_updated_by_username` as 'last_updated_by_username', `beyond_workingHours_table`.`last_updated_by` as 'last_updated_by', `beyond_workingHours_table`.`last_updated_at` as 'last_updated_at'",
		...
		$pcConfig = [
			...
			'star_pnt' => [
				'iittnif_id' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'IITTNiF id', 3 => 'Name of the Candidate', 4 => 'Institute', 5 => 'Workspace', 6 => 'Year and department', 7 => 'Project title', 8 => 'Created By', 9 => 'Last Updated By'],
					'display-field-names' => [0 => 'id', 2 => 'iittnif_id', 3 => 'name_of_the_candidate', 4 => 'institute', 5 => 'workspace', 6 => 'year_and_department', 7 => 'project_title', 8 => 'created_by', 9 => 'last_updated_by'],
					'sortable-fields' => [0 => '`star_pnt`.`id`', 1 => 2, 2 => '`internship_fellowship_details_app1`.`iittnif_id`', 3 => 4, 4 => 5, 5 => 6, 6 => 7, 7 => 8, 8 => 9, 9 => 10],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
			...
			'asset_allotment_table' => [
				'asset_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Asset Details', 3 => 'Select employee', 4 => 'Department', 5 => 'Date', 6 => 'Purpose', 7 => 'Alloted by', 8 => 'Status', 9 => 'Returned date', 10 => 'Last updated by', 11 => 'Last updated at', 12 => 'Created By'],
					'display-field-names' => [0 => 'id', 2 => 'asset_lookup', 3 => 'select_employee', 4 => 'department', 5 => 'date', 6 => 'purpose', 7 => 'alloted_by', 8 => 'status', 9 => 'returned_date', 10 => 'last_updated_by', 11 => 'last_updated_at', 12 => 'created_by'],
					'sortable-fields' => [0 => '`asset_allotment_table`.`id`', 1 => 2, 2 => 3, 3 => 4, 4 => 5, 5 => '`asset_allotment_table`.`date`', 6 => 7, 7 => 8, 8 => 9, 9 => '`asset_allotment_table`.`returned_date`', 10 => 11, 11 => 12, 12 => 13],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
					...
					'query' => "SELECT `asset_allotment_table`.`id` as 'id', `asset_allotment_table`.`username` as 'username', IF(    CHAR_LENGTH(`asset_table1`.`ClassificationofAssest`) || CHAR_LENGTH(`asset_table1`.`ItemDescription`), CONCAT_WS('',   `asset_table1`.`ClassificationofAssest`, '::', `asset_table1`.`ItemDescription`), '') as 'asset_lookup', IF(    CHAR_LENGTH(`user_table1`.`memberID`) || CHAR_LENGTH(`user_table1`.`name`), CONCAT_WS('',   `user_table1`.`memberID`, '::', `user_table1`.`name`), '') as 'select_employee', `asset_allotment_table`.`department` as 'department', if(`asset_allotment_table`.`date`,date_format(`asset_allotment_table`.`date`,'%d/%m/%Y'),'') as 'date', `asset_allotment_table`.`purpose` as 'purpose', IF(    CHAR_LENGTH(`user_table2`.`memberID`) || CHAR_LENGTH(`user_table2`.`name`), CONCAT_WS('',   `user_table2`.`memberID`, '::', `user_table2`.`name`), '') as 'alloted_by', `asset_allotment_table`.`status` as 'status', if(`asset_allotment_table`.`returned_date`,date_format(`asset_allotment_table`.`returned_date`,'%d/%m/%Y'),'') as 'returned_date', `asset_allotment_table`.`last_updated_by` as 'last_updated_by', `asset_allotment_table`.`last_updated_at` as 'last_updated_at', `asset_allotment_table`.`created_by` as 'created_by' FROM `asset_allotment_table` LEFT JOIN `asset_table` as asset_table1 ON `asset_table1`.`id`=`asset_allotment_table`.`asset_lookup` LEFT JOIN `user_table` as user_table1 ON `user_table1`.`user_id`=`asset_allotment_table`.`select_employee` LEFT JOIN `user_table` as user_table2 ON `user_table2`.`user_id`=`asset_allotment_table`.`alloted_by` "
				],
				'select_employee' => [
					'parent-table' => 'user_table',
					'parent-primary-key' => 'user_id',
			...
			'sub_asset_allotment_table' => [
				'sub_asset_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Sub Asset Details', 3 => 'Select employee', 4 => 'Department', 5 => 'Date', 6 => 'Purpose', 7 => 'Alloted by', 8 => 'Status', 9 => 'Returned date', 10 => 'Last updated by', 11 => 'Last updated at', 12 => 'Created By'],
					'display-field-names' => [0 => 'id', 2 => 'sub_asset_lookup', 3 => 'select_employee', 4 => 'department', 5 => 'date', 6 => 'purpose', 7 => 'alloted_by', 8 => 'status', 9 => 'returned_date', 10 => 'last_updated_by', 11 => 'last_updated_at', 12 => 'created_by'],
					'sortable-fields' => [0 => '`sub_asset_allotment_table`.`id`', 1 => 2, 2 => 3, 3 => 4, 4 => 5, 5 => '`sub_asset_allotment_table`.`date`', 6 => 7, 7 => 8, 8 => 9, 9 => '`sub_asset_allotment_table`.`returned_date`', 10 => 11, 11 => 12, 12 => 13],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
			...
			'it_inventory_app' => [
				'sactioned_by' => [
					...
					'sortable-fields' => [0 => '`it_inventory_app`.`it_inventory_id`', 1 => 2, 2 => '`it_inventory_app`.`date`', 3 => 4, 4 => 5, 5 => 6, 6 => 7, 7 => 8, 8 => 9, 9 => 10, 10 => 11, 11 => 12, 12 => 13, 13 => '`it_inventory_app`.`date_of_useful_life_of_assets_ends`', 14 => 15, 15 => 16, 16 => 17, 17 => 18, 18 => 19, 19 => 20],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
					...
					'query' => "SELECT `it_inventory_app`.`it_inventory_id` as 'it_inventory_id', `it_inventory_app`.`username` as 'username', if(`it_inventory_app`.`date`,date_format(`it_inventory_app`.`date`,'%d/%m/%Y'),'') as 'date', `it_inventory_app`.`description` as 'description', `it_inventory_app`.`classification_of_asset` as 'classification_of_asset', `it_inventory_app`.`sub_category` as 'sub_category', `it_inventory_app`.`qty` as 'qty', `it_inventory_app`.`asset_serial_number` as 'asset_serial_number', `it_inventory_app`.`qr_and_bar_code` as 'qr_and_bar_code', `it_inventory_app`.`custody_department` as 'custody_department', `it_inventory_app`.`custodian` as 'custodian', `it_inventory_app`.`custodian_signature` as 'custodian_signature', `it_inventory_app`.`no_of_years_useful_life_of_assets` as 'no_of_years_useful_life_of_assets', if(`it_inventory_app`.`date_of_useful_life_of_assets_ends`,date_format(`it_inventory_app`.`date_of_useful_life_of_assets_ends`,'%d/%m/%Y'),'') as 'date_of_useful_life_of_assets_ends', `it_inventory_app`.`remarks` as 'remarks', IF(    CHAR_LENGTH(`user_table1`.`memberID`) || CHAR_LENGTH(`user_table1`.`name`), CONCAT_WS('',   `user_table1`.`memberID`, '::', `user_table1`.`name`), '') as 'sactioned_by', `it_inventory_app`.`it_inventory_str` as 'it_inventory_str', `it_inventory_app`.`last_updated_by` as 'last_updated_by', `it_inventory_app`.`last_updated_at` as 'last_updated_at', `it_inventory_app`.`created_by` as 'created_by' FROM `it_inventory_app` LEFT JOIN `user_table` as user_table1 ON `user_table1`.`user_id`=`it_inventory_app`.`sactioned_by` "
				],
			],
			'it_inventory_billing_details' => [
				'it_inventory_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'IT inventory ', 3 => 'PO Number', 4 => 'PO Date', 5 => 'Particulars of supplier', 6 => 'Item description', 7 => 'Bill no', 8 => 'Bill date', 9 => 'Quantity', 10 => 'Total invoice value', 11 => 'Cost of the asset', 12 => 'Image', 13 => 'Last updated by', 14 => 'Last updated at', 15 => 'Created By'],
					'display-field-names' => [0 => 'it_inventory_biling_details_id', 2 => 'it_inventory_lookup', 3 => 'po_no', 4 => 'po_date', 5 => 'particulars_of_supplier', 6 => 'item_description', 7 => 'bill_no', 8 => 'bill_date', 9 => 'quantity', 10 => 'total_invoice_value', 11 => 'cost_of_the_asset', 12 => 'image', 13 => 'last_updated_by', 14 => 'last_updated_at', 15 => 'created_by'],
					'sortable-fields' => [0 => '`it_inventory_billing_details`.`it_inventory_biling_details_id`', 1 => 2, 2 => 3, 3 => 4, 4 => '`it_inventory_billing_details`.`po_date`', 5 => 6, 6 => 7, 7 => 8, 8 => '`it_inventory_billing_details`.`bill_date`', 9 => 10, 10 => 11, 11 => 12, 12 => 13, 13 => 14, 14 => 15, 15 => 16],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
			...
			'it_inventory_allotment_table' => [
				'select_employee' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Select employee', 3 => 'Department', 4 => 'Date', 5 => 'Inventory Details', 6 => 'Purpose', 7 => 'Alloted by', 8 => 'Allotment Status', 9 => 'Approval status', 10 => 'Approval remarks', 11 => 'Return status', 12 => 'Returned date', 13 => 'Last updated by', 14 => 'Last updated at', 15 => 'Created By'],
					'display-field-names' => [0 => 'id', 2 => 'select_employee', 3 => 'department', 4 => 'date', 5 => 'inventory_details', 6 => 'purpose', 7 => 'alloted_by', 8 => 'allotment_status', 9 => 'approval_status', 10 => 'approval_remarks', 11 => 'return_status', 12 => 'returned_date', 13 => 'last_updated_by', 14 => 'last_updated_at', 15 => 'created_by'],
					'sortable-fields' => [0 => '`it_inventory_allotment_table`.`id`', 1 => 2, 2 => 3, 3 => 4, 4 => '`it_inventory_allotment_table`.`date`', 5 => 6, 6 => 7, 7 => 8, 8 => 9, 9 => 10, 10 => 11, 11 => 12, 12 => '`it_inventory_allotment_table`.`returned_date`', 13 => 14, 14 => 15, 15 => 16],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
					...
					'query' => "SELECT `it_inventory_allotment_table`.`id` as 'id', `it_inventory_allotment_table`.`username` as 'username', IF(    CHAR_LENGTH(`employees_personal_data_table1`.`id`) || CHAR_LENGTH(`employees_personal_data_table1`.`name`), CONCAT_WS('',   `employees_personal_data_table1`.`id`, '  ', `employees_personal_data_table1`.`name`), '') as 'select_employee', `it_inventory_allotment_table`.`department` as 'department', if(`it_inventory_allotment_table`.`date`,date_format(`it_inventory_allotment_table`.`date`,'%d/%m/%Y'),'') as 'date', `it_inventory_allotment_table`.`inventory_details` as 'inventory_details', `it_inventory_allotment_table`.`purpose` as 'purpose', IF(    CHAR_LENGTH(`user_table1`.`memberID`) || CHAR_LENGTH(`user_table1`.`name`), CONCAT_WS('',   `user_table1`.`memberID`, '::', `user_table1`.`name`), '') as 'alloted_by', `it_inventory_allotment_table`.`allotment_status` as 'allotment_status', `it_inventory_allotment_table`.`approval_status` as 'approval_status', `it_inventory_allotment_table`.`approval_remarks` as 'approval_remarks', `it_inventory_allotment_table`.`return_status` as 'return_status', if(`it_inventory_allotment_table`.`returned_date`,date_format(`it_inventory_allotment_table`.`returned_date`,'%d/%m/%Y'),'') as 'returned_date', `it_inventory_allotment_table`.`last_updated_by` as 'last_updated_by', `it_inventory_allotment_table`.`last_updated_at` as 'last_updated_at', `it_inventory_allotment_table`.`created_by` as 'created_by' FROM `it_inventory_allotment_table` LEFT JOIN `employees_personal_data_table` as employees_personal_data_table1 ON `employees_personal_data_table1`.`id`=`it_inventory_allotment_table`.`select_employee` LEFT JOIN `user_table` as user_table1 ON `user_table1`.`user_id`=`it_inventory_allotment_table`.`alloted_by` "
				],
				'alloted_by' => [
					'parent-table' => 'user_table',
					'parent-primary-key' => 'user_id',
			...
			'computer_user_details' => [
				'pc_id' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 1 => 'PC ID', 2 => 'Entry time', 3 => 'Exit time', 4 => 'Date', 5 => 'Created By', 6 => 'Last Updated By'],
					'display-field-names' => [0 => 'id', 1 => 'pc_id', 2 => 'entry_time', 3 => 'exit_time', 4 => 'date', 5 => 'created_by', 6 => 'last_updated_by'],
					'sortable-fields' => [0 => '`computer_user_details`.`id`', 1 => 2, 2 => '`computer_user_details`.`entry_time`', 3 => '`computer_user_details`.`exit_time`', 4 => '`computer_user_details`.`date`', 5 => 6, 6 => 7],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
			...
			'computer_allotment_table' => [
				'pc_id' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 1 => 'PC ID', 2 => 'Name of user', 3 => 'Role', 4 => 'From date', 5 => 'To date', 6 => 'Purpose', 7 => 'Email ID', 8 => 'Mobile number', 9 => 'Created By', 10 => 'Last Updated By', 11 => 'Emp details'],
					'display-field-names' => [0 => 'id', 1 => 'pc_id', 2 => 'name_of_user', 3 => 'role', 4 => 'from_date', 5 => 'to_date', 6 => 'purpose', 7 => 'email_d', 8 => 'mobile_number', 9 => 'created_by', 10 => 'last_updated_by', 11 => 'emp_details'],
					'sortable-fields' => [0 => '`computer_allotment_table`.`id`', 1 => 2, 2 => 3, 3 => 4, 4 => '`computer_allotment_table`.`from_date`', 5 => '`computer_allotment_table`.`to_date`', 6 => 7, 7 => 8, 8 => 9, 9 => 10, 10 => 11, 11 => 12],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
