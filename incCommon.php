	...
	*/
	...
	function get_sql_fields($table_name) {
		$sql_fields = [
			...
			'employees_appraisal_table' => "`employees_appraisal_table`.`id` as 'id', IF(    CHAR_LENGTH(`employees_personal_data_table1`.`emp_id`) || CHAR_LENGTH(`employees_personal_data_table1`.`name`), CONCAT_WS('',   `employees_personal_data_table1`.`emp_id`, '::', `employees_personal_data_table1`.`name`), '') as 'employee_lookup', IF(    CHAR_LENGTH(`employees_designation_table1`.`designation`) || CHAR_LENGTH(`user_table1`.`memberID`) || CHAR_LENGTH(`user_table1`.`name`), CONCAT_WS('',   `employees_designation_table1`.`designation`, '::', `user_table1`.`memberID`, '::', `user_table1`.`name`), '') as 'employee_designation_reporting_lookup', `employees_appraisal_table`.`current_review_period` as 'current_review_period', `employees_appraisal_table`.`roles` as 'roles', `employees_appraisal_table`.`self_explanation` as 'self_explanation', `employees_appraisal_table`.`upload_file_1` as 'upload_file_1', `employees_appraisal_table`.`upload_file_2` as 'upload_file_2', `employees_appraisal_table`.`upload_file_3` as 'upload_file_3', `employees_appraisal_table`.`appraisal_status` as 'appraisal_status', `employees_appraisal_table`.`created_by` as 'created_by', `employees_appraisal_table`.`created_at` as 'created_at', `employees_appraisal_table`.`last_updated_by` as 'last_updated_by', `employees_appraisal_table`.`last_updated_at` as 'last_updated_at'",
		...
		$pcConfig = [
			...
			'employees_appraisal_table' => [
				'employee_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 1 => 'Employee Details', 2 => 'Employee Other Details (Designation::Reporting Officer)', 3 => 'Current review period', 4 => 'Roles & Responsibilities', 5 => 'Employee Self-explanation', 6 => 'Upload file 1', 7 => 'Upload file 2', 8 => 'Upload file 3', 9 => 'Appraisal status', 10 => 'Created by', 11 => 'Created at', 12 => 'Last updated by', 13 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 1 => 'employee_lookup', 2 => 'employee_designation_reporting_lookup', 3 => 'current_review_period', 4 => 'roles', 5 => 'self_explanation', 6 => 'upload_file_1', 7 => 'upload_file_2', 8 => 'upload_file_3', 9 => 'appraisal_status', 10 => 'created_by', 11 => 'created_at', 12 => 'last_updated_by', 13 => 'last_updated_at'],
					...
					'query' => "SELECT `employees_appraisal_table`.`id` as 'id', IF(    CHAR_LENGTH(`employees_personal_data_table1`.`emp_id`) || CHAR_LENGTH(`employees_personal_data_table1`.`name`), CONCAT_WS('',   `employees_personal_data_table1`.`emp_id`, '::', `employees_personal_data_table1`.`name`), '') as 'employee_lookup', IF(    CHAR_LENGTH(`employees_designation_table1`.`designation`) || CHAR_LENGTH(`user_table1`.`memberID`) || CHAR_LENGTH(`user_table1`.`name`), CONCAT_WS('',   `employees_designation_table1`.`designation`, '::', `user_table1`.`memberID`, '::', `user_table1`.`name`), '') as 'employee_designation_reporting_lookup', `employees_appraisal_table`.`current_review_period` as 'current_review_period', `employees_appraisal_table`.`roles` as 'roles', `employees_appraisal_table`.`self_explanation` as 'self_explanation', `employees_appraisal_table`.`upload_file_1` as 'upload_file_1', `employees_appraisal_table`.`upload_file_2` as 'upload_file_2', `employees_appraisal_table`.`upload_file_3` as 'upload_file_3', `employees_appraisal_table`.`appraisal_status` as 'appraisal_status', `employees_appraisal_table`.`created_by` as 'created_by', `employees_appraisal_table`.`created_at` as 'created_at', `employees_appraisal_table`.`last_updated_by` as 'last_updated_by', `employees_appraisal_table`.`last_updated_at` as 'last_updated_at' FROM `employees_appraisal_table` LEFT JOIN `employees_personal_data_table` as employees_personal_data_table1 ON `employees_personal_data_table1`.`id`=`employees_appraisal_table`.`employee_lookup` LEFT JOIN `employees_designation_table` as employees_designation_table1 ON `employees_designation_table1`.`id`=`employees_appraisal_table`.`employee_designation_reporting_lookup` LEFT JOIN `user_table` as user_table1 ON `user_table1`.`user_id`=`employees_designation_table1`.`reporting_officer` "
				],
				'employee_designation_reporting_lookup' => [
