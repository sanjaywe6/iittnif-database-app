	...
	*/
	...
	function get_sql_from($table_name, $skip_permissions = false, $skip_joins = false, $lower_permissions = false) {
		$sql_from = [
			...
			'beyond_workingHours_table' => "`beyond_workingHours_table` ",
			'leave_table' => "`leave_table` ",
		...
		$pcConfig = [
			...
			'it_inventory_allotment_table' => [
				'select_employee' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 2 => 'Select employee', 3 => 'Department', 4 => 'Date', 5 => 'Inventory Details', 6 => 'Purpose', 7 => 'Alloted by', 8 => 'Allotment Status', 9 => 'Approval status', 10 => 'Approval remarks', 11 => 'Return status', 12 => 'Returned date', 13 => 'Created by', 14 => 'Created at', 15 => 'Last updated by', 16 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 2 => 'select_employee', 3 => 'department', 4 => 'date', 5 => 'inventory_details', 6 => 'purpose', 7 => 'alloted_by', 8 => 'allotment_status', 9 => 'approval_status', 10 => 'approval_remarks', 11 => 'return_status', 12 => 'returned_date', 13 => 'created_by', 14 => 'created_at', 15 => 'last_updated_by', 16 => 'last_updated_at'],
