		...
		$pcConfig = [
			...
			'computer_allotment_table' => [
				'pc_id' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 1 => 'PC ID', 2 => 'Name of user', 3 => 'Role', 4 => 'Employee Details (Optional)', 5 => 'From date', 6 => 'To date', 7 => 'Purpose', 8 => 'Email ID', 9 => 'Mobile number', 10 => 'Created By', 11 => 'Last Updated By'],
					'display-field-names' => [0 => 'id', 1 => 'pc_id', 2 => 'name_of_user', 3 => 'role', 4 => 'emp_details', 5 => 'from_date', 6 => 'to_date', 7 => 'purpose', 8 => 'email_d', 9 => 'mobile_number', 10 => 'created_by', 11 => 'last_updated_by'],
					'sortable-fields' => [0 => '`computer_allotment_table`.`id`', 1 => 2, 2 => 3, 3 => 4, 4 => 5, 5 => '`computer_allotment_table`.`from_date`', 6 => '`computer_allotment_table`.`to_date`', 7 => 8, 8 => 9, 9 => 10, 10 => 11, 11 => 12],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
