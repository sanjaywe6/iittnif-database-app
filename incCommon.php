		...
		$pcConfig = [
			...
			'asset_allotment_table' => [
				'asset_lookup' => [
					...
					'display-field-names' => [0 => 'id', 1 => 'asset_lookup', 2 => 'select_employee', 3 => 'department', 4 => 'date', 5 => 'purpose', 6 => 'alloted_by', 7 => 'status', 8 => 'returned_date', 9 => 'created_by', 10 => 'created_at', 11 => 'last_updated_by', 12 => 'last_updated_at'],
			...
			'sub_asset_allotment_table' => [
				'sub_asset_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 1 => 'Sub Asset Details', 2 => 'Select employee', 3 => 'Department', 4 => 'Date', 5 => 'Purpose', 6 => 'Alloted by', 7 => 'Status', 8 => 'Returned date', 9 => 'Created by', 10 => 'Created at', 11 => 'Last updated by', 12 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 1 => 'sub_asset_lookup', 2 => 'select_employee', 3 => 'department', 4 => 'date', 5 => 'purpose', 6 => 'alloted_by', 7 => 'status', 8 => 'returned_date', 9 => 'created_by', 10 => 'created_at', 11 => 'last_updated_by', 12 => 'last_updated_at'],
					'sortable-fields' => [0 => '`sub_asset_allotment_table`.`id`', 1 => 2, 2 => 3, 3 => 4, 4 => '`sub_asset_allotment_table`.`date`', 5 => 6, 6 => 7, 7 => 8, 8 => '`sub_asset_allotment_table`.`returned_date`', 9 => 10, 10 => 11, 11 => 12, 12 => 13],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
					...
					'query' => "SELECT `sub_asset_allotment_table`.`id` as 'id', IF(    CHAR_LENGTH(`sub_asset_table1`.`ClassificationofAssest`) || CHAR_LENGTH(`sub_asset_table1`.`ItemDescription`), CONCAT_WS('',   `sub_asset_table1`.`ClassificationofAssest`, '::', `sub_asset_table1`.`ItemDescription`), '') as 'sub_asset_lookup', IF(    CHAR_LENGTH(`user_table1`.`memberID`) || CHAR_LENGTH(`user_table1`.`name`), CONCAT_WS('',   `user_table1`.`memberID`, '::', `user_table1`.`name`), '') as 'select_employee', `sub_asset_allotment_table`.`department` as 'department', if(`sub_asset_allotment_table`.`date`,date_format(`sub_asset_allotment_table`.`date`,'%d/%m/%Y'),'') as 'date', `sub_asset_allotment_table`.`purpose` as 'purpose', IF(    CHAR_LENGTH(`user_table2`.`memberID`) || CHAR_LENGTH(`user_table2`.`name`), CONCAT_WS('',   `user_table2`.`memberID`, '::', `user_table2`.`name`), '') as 'alloted_by', `sub_asset_allotment_table`.`status` as 'status', if(`sub_asset_allotment_table`.`returned_date`,date_format(`sub_asset_allotment_table`.`returned_date`,'%d/%m/%Y'),'') as 'returned_date', `sub_asset_allotment_table`.`created_by` as 'created_by', `sub_asset_allotment_table`.`created_at` as 'created_at', `sub_asset_allotment_table`.`last_updated_by` as 'last_updated_by', `sub_asset_allotment_table`.`last_updated_at` as 'last_updated_at' FROM `sub_asset_allotment_table` LEFT JOIN `sub_asset_table` as sub_asset_table1 ON `sub_asset_table1`.`id`=`sub_asset_allotment_table`.`sub_asset_lookup` LEFT JOIN `user_table` as user_table1 ON `user_table1`.`user_id`=`sub_asset_allotment_table`.`select_employee` LEFT JOIN `user_table` as user_table2 ON `user_table2`.`user_id`=`sub_asset_allotment_table`.`alloted_by` "
				],
				'select_employee' => [
					'parent-table' => 'user_table',
					'parent-primary-key' => 'user_id',
			...
			'employees_appraisal_table' => [
				'employee_designation_lookup' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 1 => 'Employee Details', 2 => 'Current Review Period From Date', 3 => 'Current Review Period To Date', 4 => 'Roles & Responsibilities', 5 => 'Employee Self-explanation', 6 => 'Upload file 1', 7 => 'Upload file 2', 8 => 'Upload file 3', 9 => 'Reporting Officer Feedback on the Employee Responsibilities', 10 => 'Observations by the Reporting Officer', 11 => 'Overall Rating by the Reporting Officer', 12 => 'Appraisal Feedback Status by Reporting Officer', 13 => 'Reviewing officer', 14 => 'Appraisal Feedback Status by Reviewing Officer', 15 => 'Created by', 16 => 'Created at', 17 => 'Last updated by', 18 => 'Last updated at'],
					'display-field-names' => [0 => 'id', 1 => 'employee_designation_lookup', 2 => 'current_review_period_from', 3 => 'current_review_period_to', 4 => 'roles', 5 => 'self_explanation', 6 => 'upload_file_1', 7 => 'upload_file_2', 8 => 'upload_file_3', 9 => 'reporting_officer_feedback', 10 => 'observations_by_reporting_officer', 11 => 'overall_rating', 12 => 'reporting_appraisal_status', 13 => 'reviewing_officer', 14 => 'reviewing_appraisal_status', 15 => 'created_by', 16 => 'created_at', 17 => 'last_updated_by', 18 => 'last_updated_at'],
					'sortable-fields' => [0 => '`employees_appraisal_table`.`id`', 1 => 2, 2 => '`employees_appraisal_table`.`current_review_period_from`', 3 => '`employees_appraisal_table`.`current_review_period_to`', 4 => 5, 5 => 6, 6 => 7, 7 => 8, 8 => 9, 9 => 10, 10 => 11, 11 => 12, 12 => 13, 13 => 14, 14 => 15, 15 => 16, 16 => 17, 17 => 18, 18 => 19],
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
