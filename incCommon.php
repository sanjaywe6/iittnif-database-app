	...
	*/
	...
	function get_sql_fields($table_name) {
		$sql_fields = [
			...
			'r_and_d_progress' => "`r_and_d_progress`.`id` as 'id', if(`r_and_d_progress`.`date`,date_format(`r_and_d_progress`.`date`,'%d/%m/%Y'),'') as 'date', `r_and_d_progress`.`labs` as 'labs', `r_and_d_progress`.`today_progress` as 'today_progress', `r_and_d_progress`.`tomorrow_plan` as 'tomorrow_plan', `r_and_d_progress`.`ceo_remarks` as 'ceo_remarks', `r_and_d_progress`.`pd_remarks` as 'pd_remarks', `r_and_d_progress`.`created_by` as 'created_by', `r_and_d_progress`.`created_at` as 'created_at', `r_and_d_progress`.`last_updated_by` as 'last_updated_by', `r_and_d_progress`.`last_updated_at` as 'last_updated_at'",
