		...
		$pcConfig = [
			...
			'computer_user_details' => [
				'pc_id' => [
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [0 => 'ID', 1 => 'PC ID', 2 => 'Time', 3 => 'Type', 4 => 'Date', 5 => 'Created By', 6 => 'Last Updated By', 7 => 'Created By Username', 8 => 'Created At', 9 => 'Last Updated by Username', 10 => 'Last Updated At'],
					'display-field-names' => [0 => 'id', 1 => 'pc_id', 2 => 'time', 3 => 'type', 4 => 'date', 5 => 'created_by', 6 => 'last_updated_by', 7 => 'created_by_username', 8 => 'created_at', 9 => 'last_updated_by_username', 10 => 'last_updated_at'],
					'sortable-fields' => [0 => '`computer_user_details`.`id`', 1 => 2, 2 => '`computer_user_details`.`time`', 3 => '`computer_user_details`.`type`', 4 => '`computer_user_details`.`date`', 5 => 6, 6 => 7, 7 => 8, 8 => 9, 9 => 10, 10 => 11],
					'records-per-page' => 10,
					'default-sort-by' => 4,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
