						...
						<div style="display: flex; justify-content:space-around;">
							<div class="row" style="margin: 10px;">
								<div class="col-sm-offset-3 col-sm-6">
									<button name="signIn" type="submit" id="submit" value="signIn" style="border: 1px solid #337ab7; border-radius:8px; padding:6px 15px; font-size:15px; background-color: #951b2a; color:white; min-width:100px;"><?php echo $Translation['sign up']; ?></button>
								</div>
							</div>

							<div style="margin:10px;">
								<a href="https://app.iittnif.in" style="text-decoration: none;">
									<p style="border: 1px solid #0d6efd; border-radius:8px; padding:6px 15px; font-size:15px; background-color: #0d6efd; color:white; min-width:170px;">Back to Home Page</p>
								</a>
							</div>
						</div>
