...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = [
		...
		"`suggestion`.`created_by_username`" => "created_by_username",
		"`suggestion`.`last_updated_by_username`" => "last_updated_by_username",
	];
	...
	$x->ColFieldName = ['suggestion_id', 'department', 'suggestion', 'attachment', 'department_remarks', 'ceo_pd_remarks', 'status', 'created_by', 'created_at', 'last_updated_by', 'last_updated_at', ];
