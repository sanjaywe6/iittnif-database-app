...
<script>
	$j(function() {
		...
		var data = {
			asset_details: <?php echo json_encode(['id' => $rdata['asset_details'], 'value' => $rdata['asset_details'], 'text' => $jdata['asset_details']]); ?>,
		...
		/* saved value for asset_details */
		cache.addCheck(function(u, d) {
			if(u != 'ajax_combo.php') return false;
			if(d.t == tn && d.f == 'asset_details' && d.id == data.asset_details.id)
				return { results: [ data.asset_details ], more: false, elapsed: 0.01 };
			return false;
		});
