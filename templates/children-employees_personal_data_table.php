			...
			<table data-tablename="<?php echo $current_table; ?>" class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr data-id="<?php echo html_attr($pkValue); ?>">
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][13]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][13]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[13]); ?>" data-lightbox="employees_personal_data_table-profile_photo"><img src="thumbnail.php?i=<?php echo urlencode($record[13]); ?>&t=employees_personal_data_table&f=profile_photo&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][14]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][14]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[14]); ?>" data-lightbox="employees_personal_data_table-signature"><img src="thumbnail.php?i=<?php echo urlencode($record[14]); ?>&t=employees_personal_data_table&f=signature&v=tv" class="img-thumbnail"></a></td>
