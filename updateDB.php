<?php
	...
	if($thisMD5 != $prevMD5) {
		...
		setupTable('projects', [
				"ALTER TABLE `table90` RENAME `projects`",
				"UPDATE `membership_userrecords` SET `tableName`='projects' WHERE `tableName`='table90'",
				"UPDATE `membership_userpermissions` SET `tableName`='projects' WHERE `tableName`='table90'",
				"UPDATE `membership_grouppermissions` SET `tableName`='projects' WHERE `tableName`='table90'",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `id` `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ",
				"ALTER TABLE `projects` CHANGE `field1` `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `field1` `caregory` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` CHANGE `caregory` `category` VARCHAR(255) NULL ",
				" ALTER TABLE `projects` CHANGE `category` `category` VARCHAR(255) NULL DEFAULT 'PRAYAS' ",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `field1` `collaboration_partner_type` VARCHAR(255) NULL ",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `field1` `collaboration_partner_name` VARCHAR(255) NULL ",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `field1` `Project_title` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` CHANGE `Project_title` `project_title` VARCHAR(255) NULL ",
				" ALTER TABLE `projects` CHANGE `project_title` `project_title` VARCHAR(255) NOT NULL ",
				" ALTER TABLE `projects` CHANGE `collaboration_partner_name` `collaboration_partner_name` VARCHAR(255) NOT NULL ",
				" ALTER TABLE `projects` CHANGE `collaboration_partner_type` `collaboration_partner_type` VARCHAR(255) NULL DEFAULT 'Institute' ",
				"ALTER TABLE `projects` ADD `trl_level` VARCHAR(255) NOT NULL ",
				" ALTER TABLE `projects` CHANGE `trl_level` `trl_level` VARCHAR(255) NULL ",
				" ALTER TABLE `projects` CHANGE `trl_level` `trl_level` VARCHAR(255) NULL DEFAULT 'TRL 1' ",
				" ALTER TABLE `projects` CHANGE `trl_level` `trl_level` VARCHAR(255) NOT NULL DEFAULT 'TRL 1' ",
				" ALTER TABLE `projects` CHANGE `collaboration_partner_type` `collaboration_partner_type` VARCHAR(255) NOT NULL DEFAULT 'Institute' ",
				" ALTER TABLE `projects` CHANGE `category` `category` VARCHAR(255) NOT NULL DEFAULT 'PRAYAS' ",
				" ALTER TABLE `projects` CHANGE `trl_level` `trl_level` VARCHAR(255) NULL DEFAULT 'TRL 1' ",
				" ALTER TABLE `projects` CHANGE `collaboration_partner_type` `collaboration_partner_type` VARCHAR(255) NULL DEFAULT 'Institute' ",
				" ALTER TABLE `projects` CHANGE `category` `category` VARCHAR(255) NULL DEFAULT 'PRAYAS' ",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `field1` `project_status` VARCHAR(255) NULL ",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `field1` `project_commercialized` VARCHAR(255) NULL ",
				" ALTER TABLE `projects` CHANGE `project_commercialized` `project_commercialized` VARCHAR(255) NULL DEFAULT 'Yes' ",
				" ALTER TABLE `projects` CHANGE `project_status` `project_status` VARCHAR(255) NULL DEFAULT 'Ongoing' ",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `field1` `brief_of_the_project` VARCHAR(255) NULL ",
				" ALTER TABLE `projects` CHANGE `brief_of_the_project` `brief_of_the_project` TEXT NULL ",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `field1` `commercialization_areas` VARCHAR(255) NULL ",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `field1` `targeted_sdg` VARCHAR(255) NULL ",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `field1` `year_of_commercialization_area` VARCHAR(255) NULL ",
				" ALTER TABLE `projects` CHANGE `year_of_commercialization_area` `year_of_commercialization_area` YEAR NULL ",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `field1` `commercialization_value` VARCHAR(255) NULL ",
				" ALTER TABLE `projects` CHANGE `commercialization_value` `commercialization_value` INT NULL ",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `field1` `total_approved_amount` VARCHAR(255) NULL ",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `field1` `funding_released_2020` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` ADD `funding_released_2020_1` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` CHANGE `funding_released_2020_1` `funding_released_2021` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` ADD `funding_released_2021_1` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` CHANGE `funding_released_2021_1` `funding_released_2022` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` ADD `funding_released_2021_1` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` CHANGE `funding_released_2021_1` `funding_released_2023` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` ADD `funding_released_2021_1` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` CHANGE `funding_released_2021_1` `funding_released_2024` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` ADD `funding_released_2021_1` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` CHANGE `funding_released_2021_1` `funding_released_2025` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` ADD `funding_released_2021_1` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` CHANGE `funding_released_2021_1` `funding_released_2026` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` ADD `funding_released_2021_1` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` CHANGE `funding_released_2021_1` `funding_released_2027` VARCHAR(255) NULL ",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `field1` `total_value_released` VARCHAR(255) NULL ",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `field1` `external_funding_amount` VARCHAR(255) NULL ",
				"ALTER TABLE projects ADD `field1` VARCHAR(40)",
				"ALTER TABLE `projects` CHANGE `field1` `remarks` VARCHAR(255) NULL ",
				" ALTER TABLE `projects` CHANGE `remarks` `remarks` TEXT NULL ",
				"ALTER TABLE `projects` ADD `created_by_username` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` ADD `created_at` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` ADD `last_updated_by_username` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` ADD `last_updated_at` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` ADD `created_by` VARCHAR(255) NULL ",
				"ALTER TABLE `projects` ADD `last_updated_by` VARCHAR(255) NULL ",
			]);

		setupTable('td_intellectual_property', []);

		setupTable('td_technology_products', [
				" ALTER TABLE `td_technology_products` CHANGE `trl_level` `trl_level` VARCHAR(255) NULL ",
				" ALTER TABLE `td_technology_products` CHANGE `trl_level` `trl_level` VARCHAR(255) NULL DEFAULT 'TRL 1' ",
				" ALTER TABLE `td_technology_products` CHANGE `trl_level` `trl_level` VARCHAR(255) NOT NULL DEFAULT 'TRL 1' ",
			]);
