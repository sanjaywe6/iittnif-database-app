<?php
	...
	if($thisMD5 != $prevMD5) {
		...
		setupTable('ed_eir', [
				"ALTER TABLE `table99` RENAME `ed_eir`",
				"UPDATE `membership_userrecords` SET `tableName`='ed_eir' WHERE `tableName`='table99'",
				"UPDATE `membership_userpermissions` SET `tableName`='ed_eir' WHERE `tableName`='table99'",
				"UPDATE `membership_grouppermissions` SET `tableName`='ed_eir' WHERE `tableName`='table99'",
				"ALTER TABLE ed_eir ADD `field1` VARCHAR(40)",
				"ALTER TABLE `ed_eir` CHANGE `id` `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ",
				"ALTER TABLE `ed_eir` CHANGE `field1` `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ",
				"ALTER TABLE `ed_eir` ADD `year` VARCHAR(255) NOT NULL DEFAULT '2020-21' ",
				"ALTER TABLE ed_eir ADD `field1` VARCHAR(40)",
				"ALTER TABLE `ed_eir` CHANGE `field1` `name` VARCHAR(255) NULL ",
				"ALTER TABLE `ed_eir` ADD `gender` VARCHAR(255) NOT NULL DEFAULT 'Male' ",
				"ALTER TABLE `ed_eir` ADD `cast_category` VARCHAR(255) NULL DEFAULT 'SC' ",
				"ALTER TABLE `ed_eir` ADD `Technology_Domain` VARCHAR(255) NULL ",
				"ALTER TABLE `ed_eir` CHANGE `Technology_Domain` `Technology_Area` VARCHAR(255) NULL ",
				"ALTER TABLE `ed_eir` ADD `Start_Date` DATE NULL ",
				"ALTER TABLE `ed_eir` ADD `End_Date` DATE NULL ",
				"ALTER TABLE ed_eir ADD `field1` VARCHAR(40)",
				"ALTER TABLE `ed_eir` CHANGE `field1` `Co_funding_Agency_Type` VARCHAR(255) NULL ",
				"ALTER TABLE ed_eir ADD `field1` VARCHAR(40)",
				"ALTER TABLE `ed_eir` CHANGE `field1` `Co_funding_Agency_Name` VARCHAR(255) NULL ",
				"ALTER TABLE `ed_eir` ADD `trl_level` VARCHAR(255) NULL DEFAULT 'TRL 1' ",
				"ALTER TABLE ed_eir ADD `field1` VARCHAR(40)",
				"ALTER TABLE `ed_eir` CHANGE `field1` `status` VARCHAR(255) NULL ",
				"ALTER TABLE `ed_eir` ADD `created_by_username` VARCHAR(255) NULL ",
				"ALTER TABLE `ed_eir` ADD `created_at` VARCHAR(255) NULL ",
				"ALTER TABLE `ed_eir` ADD `last_updated_by_username` VARCHAR(255) NULL ",
				"ALTER TABLE `ed_eir` ADD `last_updated_at` VARCHAR(255) NULL ",
				"ALTER TABLE `ed_eir` ADD `last_updated_by` VARCHAR(255) NULL ",
				"ALTER TABLE `ed_eir` ADD `created_by` VARCHAR(255) NULL ",
			]);
