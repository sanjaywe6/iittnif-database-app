<?php
	...
	if($thisMD5 != $prevMD5) {
		...
		setupTable('hrd_Fellowship', [
				"ALTER TABLE hrd_Fellowship ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_Fellowship` DROP `field1`",
			]);

		setupTable('hrd_sd', [
				"ALTER TABLE `table102` RENAME `hrd_sd`",
				"UPDATE `membership_userrecords` SET `tableName`='hrd_sd' WHERE `tableName`='table102'",
				"UPDATE `membership_userpermissions` SET `tableName`='hrd_sd' WHERE `tableName`='table102'",
				"UPDATE `membership_grouppermissions` SET `tableName`='hrd_sd' WHERE `tableName`='table102'",
				"ALTER TABLE hrd_sd ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_sd` CHANGE `id` `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ",
				"ALTER TABLE `hrd_sd` CHANGE `field1` `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ",
				"ALTER TABLE hrd_sd ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_sd` CHANGE `field1` `Candidate_Type` VARCHAR(255) NULL ",
				"ALTER TABLE hrd_sd ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_sd` CHANGE `field1` `Title_of_the_Program` VARCHAR(255) NULL ",
				"ALTER TABLE hrd_sd ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_sd` CHANGE `field1` `Total_Number_of_Beneficiaries` VARCHAR(255) NULL ",
				" ALTER TABLE `hrd_sd` CHANGE `Total_Number_of_Beneficiaries` `Total_Number_of_Beneficiaries` INT NULL ",
				"ALTER TABLE hrd_sd ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_sd` CHANGE `field1` `Number_of_Women_Beneficiaries` VARCHAR(255) NULL ",
				" ALTER TABLE `hrd_sd` CHANGE `Number_of_Women_Beneficiaries` `Number_of_Women_Beneficiaries` INT NULL ",
				" ALTER TABLE `hrd_sd` CHANGE `Number_of_Women_Beneficiaries` `Number_of_Women_Beneficiaries` VARCHAR(40) NULL ",
				" ALTER TABLE `hrd_sd` CHANGE `Total_Number_of_Beneficiaries` `Total_Number_of_Beneficiaries` VARCHAR(40) NULL ",
				"ALTER TABLE hrd_sd ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_sd` CHANGE `field1` `Total_Number_of_SC_Beneficiaries` VARCHAR(255) NULL ",
				"ALTER TABLE hrd_sd ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_sd` CHANGE `field1` `Total_Number_of_ST_Beneficiaries` VARCHAR(255) NULL ",
				"ALTER TABLE hrd_sd ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_sd` CHANGE `field1` `category` VARCHAR(255) NULL ",
				"ALTER TABLE hrd_sd ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_sd` DROP `field1`",
				"ALTER TABLE `hrd_sd` ADD `Start_Date` DATE NULL ",
				"ALTER TABLE `hrd_sd` ADD `End_Date` DATE NULL ",
				"ALTER TABLE hrd_sd ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_sd` CHANGE `field1` `Collaborating_Organisation` VARCHAR(255) NULL ",
				" ALTER TABLE `hrd_sd` CHANGE `Collaborating_Organisation` `Collaborating_Organisation` TEXT NULL ",
				"ALTER TABLE hrd_sd ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_sd` CHANGE `field1` `Outcomes` VARCHAR(255) NULL ",
				" ALTER TABLE `hrd_sd` CHANGE `Outcomes` `Outcomes` TINYTEXT NULL ",
				" ALTER TABLE `hrd_sd` CHANGE `Outcomes` `Outcomes` TEXT NULL ",
				"ALTER TABLE `hrd_sd` ADD `created_by_username` VARCHAR(255) NULL ",
				"ALTER TABLE `hrd_sd` ADD `created_at` VARCHAR(255) NULL ",
				"ALTER TABLE `hrd_sd` ADD `last_updated_by_username` VARCHAR(255) NULL ",
				"ALTER TABLE `hrd_sd` ADD `last_updated_at` VARCHAR(255) NULL ",
				"ALTER TABLE `hrd_sd` ADD `last_updated_by` VARCHAR(255) NULL ",
				"ALTER TABLE `hrd_sd` ADD `created_by` VARCHAR(255) NULL ",
			]);
