<?php
	...
	if($thisMD5 != $prevMD5) {
		...
		setupTable('ed_job_creation', [
				"ALTER TABLE ed_job_creation ADD `field1` VARCHAR(40)",
				"ALTER TABLE `ed_job_creation` DROP `field1`",
			]);

		setupTable('hrd_Fellowship', [
				"ALTER TABLE `table101` RENAME `hrd_Fellowship`",
				"UPDATE `membership_userrecords` SET `tableName`='hrd_Fellowship' WHERE `tableName`='table101'",
				"UPDATE `membership_userpermissions` SET `tableName`='hrd_Fellowship' WHERE `tableName`='table101'",
				"UPDATE `membership_grouppermissions` SET `tableName`='hrd_Fellowship' WHERE `tableName`='table101'",
				"ALTER TABLE hrd_Fellowship ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_Fellowship` CHANGE `id` `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ",
				"ALTER TABLE `hrd_Fellowship` CHANGE `field1` `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ",
				"ALTER TABLE `hrd_Fellowship` ADD `year` VARCHAR(255) NOT NULL DEFAULT '2020-21' ",
				"ALTER TABLE `hrd_Fellowship` ADD `name` VARCHAR(255) NULL ",
				"ALTER TABLE `hrd_Fellowship` ADD `gender` VARCHAR(255) NOT NULL DEFAULT 'Male' ",
				"ALTER TABLE hrd_Fellowship ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_Fellowship` CHANGE `field1` `id_no` VARCHAR(255) NULL ",
				"ALTER TABLE hrd_Fellowship ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_Fellowship` CHANGE `field1` `institute_name` VARCHAR(255) NULL ",
				"ALTER TABLE hrd_Fellowship ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_Fellowship` CHANGE `field1` `Department` VARCHAR(255) NULL ",
				"ALTER TABLE hrd_Fellowship ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_Fellowship` CHANGE `field1` `Qualification` VARCHAR(255) NULL ",
				"ALTER TABLE hrd_Fellowship ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_Fellowship` CHANGE `field1` `Fellowship_Type` VARCHAR(255) NULL ",
				"ALTER TABLE `hrd_Fellowship` ADD `cast_category` VARCHAR(255) NULL DEFAULT 'SC' ",
				"ALTER TABLE `hrd_Fellowship` ADD `Start_Date` DATE NULL ",
				"ALTER TABLE `hrd_Fellowship` ADD `End_Date` DATE NULL ",
				"ALTER TABLE `hrd_Fellowship` ADD `created_by_username` VARCHAR(255) NULL ",
				"ALTER TABLE hrd_Fellowship ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_Fellowship` CHANGE `field1` `founded_by` VARCHAR(255) NULL ",
				"ALTER TABLE hrd_Fellowship ADD `field1` VARCHAR(40)",
				"ALTER TABLE `hrd_Fellowship` CHANGE `field1` `Amount_Granted` VARCHAR(255) NULL ",
				"ALTER TABLE `hrd_Fellowship` ADD `created_by_username_1` VARCHAR(255) NULL ",
				"ALTER TABLE `hrd_Fellowship` DROP `created_by_username_1`",
				"ALTER TABLE `hrd_Fellowship` ADD `status` VARCHAR(255) NULL ",
				"ALTER TABLE `hrd_Fellowship` ADD `created_at` VARCHAR(255) NULL ",
				"ALTER TABLE `hrd_Fellowship` ADD `last_updated_by_username` VARCHAR(255) NULL ",
				"ALTER TABLE `hrd_Fellowship` ADD `last_updated_at` VARCHAR(255) NULL ",
				"ALTER TABLE `hrd_Fellowship` ADD `last_updated_by` VARCHAR(255) NULL ",
				"ALTER TABLE `hrd_Fellowship` ADD `created_by` VARCHAR(255) NULL ",
			]);
