...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = [
		"`visiting_card_table`.`visiting_card_id`" => "visiting_card_id",
	...
	$x->SortFields = [
		1 => '`visiting_card_table`.`visiting_card_id`',
		2 => 2,
		3 => 3,
		4 => 4,
		5 => 5,
	...
	$x->QueryFieldsFilters = [
		"`visiting_card_table`.`visiting_card_id`" => "ID",
		"`visiting_card_table`.`name`" => "Name",
	...
	$x->QueryFrom = "`visiting_card_table` LEFT JOIN `user_table` as user_table1 ON `user_table1`.`user_id`=`visiting_card_table`.`given_by` ";
	$x->QueryWhere = '';
	$x->QueryOrder = '';
	...
	$x->PrimaryKey = '`visiting_card_table`.`visiting_card_id`';
	$x->DefaultSortField = '1';
	$x->DefaultSortDirection = 'desc';

	$x->ColWidth = [150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, ];
	$x->ColCaption = ['ID', 'Name', 'Recommended by', 'Designation', 'Company name', 'Mobile no', 'Email', 'Company website address', 'Given by', 'Suggested way forward', 'Front img', 'Back img', 'Created By', 'Last Updated By', 'Created By Username', 'Created At', 'Last Updated by Username', 'Last Updated At', ];
	$x->ColFieldName = ['visiting_card_id', 'name', 'recommended_by', 'designation', 'company_name', 'mobile_no', 'email', 'company_website_addr', 'given_by', 'suggested_way_forward', 'front_img', 'back_img', 'created_by', 'last_updated_by', 'created_by_username', 'created_at', 'last_updated_by_username', 'last_updated_at', ];
